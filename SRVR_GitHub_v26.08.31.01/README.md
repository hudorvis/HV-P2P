# HV P2P SRVR v26.08.31.01 — Qt Quick macOS Intel test build
...
- **W1P diagnostics extended for software Servo Enable and the EL7 output map.** The integration SRVR parses `SW_SRVON*` plus DO2 Ready/SRDY, DO3 Enabled/SRV-ST, DO4 Brake/BRK-OFF and DO5 Fault/ALARM assignment/state fields from the matching v26.08.31.01 W1P firmware.
...
- Physical CTRL E-stop, CTRL analogue-input fault (wire-compatible ADS1115 flag), CTRL loss, W1P loss and W1P/RS485 fault aggregation, hard STOP + software Servo Enable inhibit, and neutral-return re-arm.
...
- W1P status parsing and the established motion/safety command vocabulary. Legacy W1P-TS parser/config migration code remains dormant for backwards compatibility; W1P-TS is not exposed or active in the EdgeBox baseline.
...
`HV-P2P-SRVR-v26.08.31.01-macOS-Intel`

The artifact contains:

`HV P2P SRVR v26.08.31.01 macOS Intel.zip`
