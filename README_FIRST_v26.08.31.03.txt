HV P2P REVISION POLICY
======================
Each source/build change receives a normal HV P2P revision number.
Do not use labels such as "Build Fix 1" or "Build Fix 2" for release packages.
Revision mapping for 2026-08-31:
...
The next changed build will be v26.08.31.04.

HV P2P v26.08.31.03 — COMMISSIONING SOURCE BASELINE
====================================================
...
2. USB-flash CTRL-TS once with the matching v26.08.31.03 image.
...
See NATIVE_BUILD_AND_BENCH_CHECKLIST_v26.08.31.03.md for the acceptance gates.
