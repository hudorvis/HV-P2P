...
b = HVP2PBackend(version="26.09.04.03", smoke_test=True)
...
try:
    ...
    # v26.09.04.03 Virtual Position Source is a true SRVR demo mode. Setup must
    ...
    b._parse_w1p("STATUS POS_M=12.345 VEL_MPS=-4.5 IP=172.20.1.102 WRITE_EN=0 SW_SRVON=0 VEL_WD=0 SERVICE_LOCK=0 RS_STAT=CONNECTED LEAD_CFG=OK FW=v26.09.04.03")
    ...
    b2 = HVP2PBackend(version="26.09.04.03", smoke_test=True)
    try:
