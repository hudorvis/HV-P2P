# HV P2P v26.08.31.01 — Native Build & Functional Bench Checklist
...
- [ ] Confirm generated carrier hardware is `WS-ESP32S3-7`, protocol `1`, version
      `v26.08.31.01`, and its SHA matches the native CTRL-TS `.ino.bin`.
- [ ] Confirm complete CTRL app including embedded CTRL-TS image is <= `0x600000`.
- [ ] Confirm W1P app is <= `0x600000`.
- [ ] Download `HV-P2P-v26.08.31.01-Native-Firmware` artifact and retain
...
- [ ] One-time USB flash CTRL-TS v26.08.31.01 first.
- [ ] Flash W1P EdgeBox with its matching v26.08.31.01 native build.
...
Do not label v26.08.31.01 “hardware-tested” until every applicable physical gate above is recorded.
