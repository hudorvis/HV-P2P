// ============================================================
// HV P2P W1P EdgeBox v26.09.17.02
...
static const char* FW_VERSION = "v26.09.17.02";
...
// v26.09.17.02: EdgeBox W5500 + isolated native RS485; corrected EL7 SRV-ON configuration to PA4.00 / P04.00
...
// v26.09.17.02: EdgeBox W5500 + isolated native RS485; fail the physical link after two consecutive invalid/no-reply
...
// v26.09.17.02: EdgeBox W5500 + isolated native RS485; Dynamic mode is a closed cable-speed hold. Joystick sets
...
static const char* HV_UPDATE_BUILD_TOKEN = "HV_P2P_FW_ROLE=W1P;HV_P2P_FW_VERSION=v26.09.17.02";
...
static bool driveAutoEnableReady() {
  ...
  if (!g.drive_writes_enabled) {
    // v26.09.17.02: EdgeBox W5500 + isolated native RS485; only arm from WAIT on a fresh, non-zero joystick command.
...
static void serviceMotionProfile() {
  ...
  // v26.09.17.02: EdgeBox W5500 + isolated native RS485; predictive hard-limit guard.  SRVR also tapers before
...
void setup() {
  ...
  Serial.println("v26.09.17.02: SRVR-authoritative startup OTA added; existing motion, watchdog, stopped/braked service gate, IP rollback and neutral re-arm retained");
  Serial.println("============================================================");
