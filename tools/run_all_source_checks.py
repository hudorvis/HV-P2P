...
checks=[
    ...
    ['python3','-m','py_compile',str(ROOT/'SRVR_GitHub_v26.09.04.03'/'backend.py'),str(ROOT/'SRVR_GitHub_v26.09.04.03'/'main.py')],
    ['python3',str(ROOT/'SRVR_GitHub_v26.09.04.03'/'tools'/'validate_project.py')],
]
for cmd in checks:
    print('\n==>', ' '.join(cmd), flush=True)
