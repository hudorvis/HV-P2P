...
SRVR = (ROOT / 'SRVR_GitHub_v26.09.14.01' / 'backend.py').read_text(encoding='utf-8')
W1P = (ROOT / 'HV_P2P_W1P_EDGEBOX_v26.09.14.01' / 'HV_P2P_W1P_EDGEBOX_v26.09.14.01.ino').read_text(encoding='utf-8')
