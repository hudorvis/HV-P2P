...
SRVR = (ROOT / 'SRVR_GitHub_v26.09.15.02' / 'backend.py').read_text(encoding='utf-8')
W1P = (ROOT / 'HV_P2P_W1P_EDGEBOX_v26.09.15.02' / 'HV_P2P_W1P_EDGEBOX_v26.09.15.02.ino').read_text(encoding='utf-8')
