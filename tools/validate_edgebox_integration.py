...
SRVR_DIR = ROOT / 'SRVR_GitHub_v26.09.04.03'
...
# Safety-facing functions intentionally extended in v26.09.04.03 are hash-locked separately below.
expected_w1p={
...
for fn,h in expected_w1p_v07_safety.items(): must(normalized_func_hash(w,fn)==h, f'W1P v26.09.04.03 reviewed safety extension hash locked: {fn}')
...
# v26.09.04.03 independent W1P command-deadman and service safety gate.
...
# v26.09.04.03 closes the W1P Setup-IP semantic gap with a coordinated safe
...
# v26.09.04.03 locked Run/Setup revision and Virtual demo-source contract.
...
must('ctrl_version=v26.09.04.03' in c and 'FW=" + String(FW_VERSION)' in w, 'CTRL and W1P publish actual firmware identity for Setup')
