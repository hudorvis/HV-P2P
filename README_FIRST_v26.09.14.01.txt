HV P2P v26.09.14.01 — GITHUB-READY SOURCE
==========================================

MAJOR CHANGE: SRVR-AUTHORITATIVE FIRMWARE CONVERGENCE
-----------------------------------------------------
This revision adds the authority chain:
...
ONE-TIME BOOTSTRAP
------------------
Read INITIAL_BOOTSTRAP_v26.09.14.01.md before commissioning. USB/full-device flashing
...
SOURCE_TEST_RESULTS_v26.09.14.01.txt and authenticates every source file with
