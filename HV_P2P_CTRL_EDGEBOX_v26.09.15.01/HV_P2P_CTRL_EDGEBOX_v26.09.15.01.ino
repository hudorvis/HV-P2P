...
#define CTRL_VERSION "HV P2P CTRL EdgeBox v26.09.15.01"
...
static const char* DEFAULT_HMI_LAYOUT_LINE = "UIL1|title=HV P2P CTRL-TS|subtitle=v26.09.15.01|layout=main5|theme=hv|aux1=AUX 1|aux2=AUX 2|aux3=AUX 3|aux4=AUX 4|aux5=AUX 5|hint=Ready";
...
static const char* HV_UPDATE_BUILD_TOKEN = "HV_P2P_FW_ROLE=CTRL;HV_P2P_FW_VERSION=v26.09.15.01";
static const char* HV_UPDATE_TARGET_SIGNATURE = "HV_P2P_FW_TARGET=EDGEBOX_ESP100;";
static const char* HV_CTRL_SEMVER = "v26.09.15.01";
...
static void hvLoadHmiLayoutConfig() {
  ...
  if(hvValidateHmiLayoutLine(stored, reason)) {
    ...
    stored.trim();
    // v26.09.15.01 migration: older CTRL NVS layouts were main4/aux1-aux4.
...
static void sendHmiStatusToSrvr()
{
  ...
  line += "|ctrl_version=v26.09.15.01";
...
static void handleUdpRx()
{
  ...
  if(line.startsWith("DSP1|")) {
    ...
    // v26.09.15.01: store latest SRVR display packet only. The UART
...
void loop()
{
  ...
  // v26.09.15.01: do not resend UIL1 layout on a timer.
