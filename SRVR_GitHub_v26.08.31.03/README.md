# HV P2P SRVR v26.08.31.03 — Qt Quick macOS Intel test build
...
- **W1P diagnostics extended for software Servo Enable and the EL7 output map.** The integration SRVR parses `SW_SRVON*` plus DO2 Ready/SRDY, DO3 Enabled/SRV-ST, DO4 Brake/BRK-OFF and DO5 Fault/ALARM assignment/state fields from the matching v26.08.31.03 W1P firmware.
...
`HV-P2P-SRVR-v26.08.31.03-macOS-Intel`

The artifact contains:

`HV P2P SRVR v26.08.31.03 macOS Intel.zip`
