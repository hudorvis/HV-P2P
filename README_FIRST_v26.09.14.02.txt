HV P2P v26.09.14.02 — GITHUB-READY SOURCE
==========================================

SRVR-AUTHORITATIVE FIRMWARE CONVERGENCE + NATIVE CI FIX
-----------------------------------------------------
This revision carries forward the v26.09.14.01 authority chain and fixes the native
EdgeBox compile blocker found by GitHub Actions: Arduino ESP32 core 3.3.8 `Print.h`
defines `HEX` as a macro, which collided with the OTA SHA helper lookup symbol.
...
ONE-TIME BOOTSTRAP
------------------
Read INITIAL_BOOTSTRAP_v26.09.14.02.md before commissioning. USB/full-device flashing
...
SOURCE_TEST_RESULTS_v26.09.14.02.txt and authenticates every source file with
