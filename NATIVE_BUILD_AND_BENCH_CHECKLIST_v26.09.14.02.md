# HV P2P v26.09.14.02 — Native Build & Functional Bench Checklist
...
- [ ] Confirm compiled CTRL contains both `HV_P2P_FW_ROLE=CTRL;HV_P2P_FW_VERSION=v26.09.14.02` and `HV_P2P_FW_TARGET=EDGEBOX_ESP100;`.
- [ ] Confirm compiled W1P contains both `HV_P2P_FW_ROLE=W1P;HV_P2P_FW_VERSION=v26.09.14.02` and `HV_P2P_FW_TARGET=EDGEBOX_ESP100;`.
...
Follow `INITIAL_BOOTSTRAP_v26.09.14.02.md`. Keep the physical winch unable to move throughout bootstrap.

- [ ] One-time USB/full-device bootstrap CTRL-TS with v26.09.14.02 compatible firmware/partition map.
- [ ] One-time USB/full-device bootstrap W1P with the authority-aware v26.09.14.02 firmware and 16 MB dual-OTA partition map.
...
## K. v26.09.14.02 locked Run / Setup / Virtual acceptance
...
Do not label v26.09.14.02 “hardware-tested” until every applicable physical gate above is recorded.
